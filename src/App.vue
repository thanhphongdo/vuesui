<template>
  ...
  <div class="application">
    <Sidebar ref="sidebar" class="inverted vertical menu" context=".application" v-on:onShow="onShowMenu">
      <a class="item">1</a>
      <a class="item">2</a>
      <a class="item">3</a>
    </Sidebar>
    <div class="pusher">
        ...
        <div>
          <form>
            ...
            <Checkbox
              ...
              v-on:onChecked="console.log($event)"
              ...
              radio="true"
            ></Checkbox>
            <Dropdown ref="dropdown" multiple="true">
      ...
      <Modal ref="modal" allowMultiple="true">
      ...
      <Modal ref="modal2" class="small" allowMultiple="true">
        <i class="close icon"></i>
        <div class="header">Select a Photo</div>
